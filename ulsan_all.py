...
<body style="font-family: 'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
        ...
        오늘({datetime.now().strftime('%Y-%m-%d')}) 업데이트된 주요 기관의 지원사업 소식을 전해드립니다.</p>
        ...
        <div style="margin-top: 30px; text-align: center;">
            <a href="https://www.utp.or.kr" style="background-color: #004792; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;">
                기관 사이트 바로가기
            </a>
        </div>
...
msg = MIMEText(html_content, 'html') # <--- 중요: 'html'로 설정
